...
class _StuckMinimaxStream:
    """Minimax (anthropic-SDK-shaped) stream whose iterator never honors
    ``response.close()`` — the buffering-proxy scenario (#279)."""
