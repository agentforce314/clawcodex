...
- [四、Agent 核心能力（规划中）](#四、agent-核心能力（规划中）)
  ...
  - [4.9 CreateAgentTool 动态工具创建](#4.9-createagenttool-动态工具创建)
  ...
  - [4.10 sessionStorage 容量限制](#4.10-sessionstorage-容量限制)
  ...
  - [4.12 Issue 语义澄清流程（自主模式扩展）](#4.12-issue-语义澄清流程（自主模式扩展）)
  - [4.13 Auto 模式 (TRANSCRIPT_CLASSIFIER)](#4.13-auto-模式-transcript_classifier)
  ...
  - [4.14 Agent 间自主观察与消息交互](#4.14-agent-间自主观察与消息交互)
