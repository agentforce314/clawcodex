 ...
 *  `(string & {})` keeps literal autocomplete for the named/hex unions while also
 *  accepting arbitrary strings (e.g. clawcodex theme values), matching upstream
 *  ink's permissive `Color` (chalk validates the actual value at runtime). */
