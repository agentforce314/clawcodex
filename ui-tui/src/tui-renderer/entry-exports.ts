...
// NOTE: clawcodex uses a hand-rolled input (VimInput), so the upstream
// ink-text-input re-export is intentionally dropped — keeping it would pull
// ink@5 back in via its peerDependency and defeat the renderer swap.
