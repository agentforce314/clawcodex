...
export default [
  ...
  {
    // THE PLUGIN FENCE: plugins speak @clawcodex/plugin-sdk (+ react), never `@/…`
    ...
    rules: {
      'no-restricted-imports': [
        'error',
        {
          patterns: [
            {
              group: ['@/*', '../*', '@clawcodex/shared'],
              message: 'Plugins import only @clawcodex/plugin-sdk (and react). Missing something? Add it to the SDK.'
            }
          ]
        }
      ]
