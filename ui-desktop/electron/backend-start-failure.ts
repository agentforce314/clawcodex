 ...
 * startClawCodex() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startClawCodex() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startClawCodex`, re-emits
