...
// by main.ts (`setBackgroundThrottling` driven by the merged `clawcodex:active-work`
...
// (the "ClawCodex idles at 20% CPU while minimized" bug). The preload path is
...
// conversation started by the "Hey ClawCodex" wake word has NO preceding click,
