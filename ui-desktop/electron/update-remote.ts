 ...
 *
 * A public install can end up with `origin=git@github.com:agentforce314/clawcodex.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/agentforce314/clawcodex.git'
const OFFICIAL_REPO_CANONICAL = 'github.com/agentforce314/clawcodex'
