...
cd apps/desktop
XCURSOR_SIZE=24 CLAWCODEX_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/clawcodex-typing
# → /tmp/clawcodex-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/clawcodex-typing.before.heapsnapshot
# → /tmp/clawcodex-typing.after.heapsnapshot
```
