...
const emojibaseAssets = () => ({
  name: 'clawcodex:emojibase-assets',
...
export default defineConfig(({ command }) => ({
  ...
  css: {
    ...
    // `C:\Users\<name>\AppData\Local\clawcodex\clawcodex\apps\desktop`), so an
  ...
  resolve: {
    alias: {
      ...
      '@clawcodex/plugin-sdk': path.resolve(__dirname, './src/sdk/index.ts'),
      '@clawcodex/shared/billing': path.resolve(__dirname, 'packages/shared/src/billing-types.ts'),
      '@clawcodex/shared': path.resolve(__dirname, 'packages/shared/src'),
