/**
 * @clawcodex/plugin-sdk — THE plugin language. The vscode-module model: plugin
 ...
 *    object as `window.__CLAWCODEX_PLUGIN_SDK__` and maps the import to it, so a
...
import { getLogs, getStatus } from '@/clawcodex'
...
/** ClawCodex' reasoning levels + their compact labels, so a plugin surfacing a
...
export type { RpcEvent, StatusResponse } from '@/types/clawcodex'
