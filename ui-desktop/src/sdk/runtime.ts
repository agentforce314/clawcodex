 ...
 * plugins resolve `@clawcodex/plugin-sdk` through the vite alias; RUNTIME-loaded
...
const GLOBALS = {
  __CLAWCODEX_PLUGIN_SDK__: sdk,
  __CLAWCODEX_REACT__: React,
  __CLAWCODEX_REACT_JSX__: jsxRuntime,
  __CLAWCODEX_REACT_JSX_DEV__: jsxDevRuntime
} as const
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@clawcodex/plugin-sdk': shimUrl('__CLAWCODEX_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__CLAWCODEX_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__CLAWCODEX_REACT_JSX__'),
    react: shimUrl('__CLAWCODEX_REACT__')
  }
