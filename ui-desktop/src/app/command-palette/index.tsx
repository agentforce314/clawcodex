...
import { getClawCodexConfigRecord, listAllProfileSessions } from '@/clawcodex'
...
// ClawCodex session ids: <YYYYMMDD>_<HHMMSS>_<6 hex>. Used to offer a direct
...
function CommandPaletteBody({ onExited }: { onExited: () => void }) {
  ...
  const configQuery = useQuery({
    ...
    queryFn: getClawCodexConfigRecord
  })
        ...
        : []),
      {
        ...
        items: [
          ...
          },
          {
            ...
            icon: Download,
            id: 'cc-update-clawcodex',
            keywords: ['update', 'upgrade', 'clawcodex', 'version', 'system', 'restart'],
            label: cc.updateClawCodex,
