...
import type { StarmapEdge, StarmapGraph, StarmapNode } from '@/types/clawcodex'
...
const VERSION = 3
const PREFIX = 'HML' // "ClawCodex Memory Loadout" — namespaces our codes like WoW's leading bytes.
