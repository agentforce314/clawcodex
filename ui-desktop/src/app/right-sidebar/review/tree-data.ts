import type { ClawCodexReviewFile } from '@/global'
...
export function buildReviewFlatList(files: ClawCodexReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: ClawCodexReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
