...
const TAKEOVER_KEY = 'clawcodex.desktop.terminalTakeover'
 ...
 *  (CLI-managed) providers, which ClawCodex can't clear via the API — the user
 *  sees exactly what runs instead of ClawCodex silently deleting their creds. */
