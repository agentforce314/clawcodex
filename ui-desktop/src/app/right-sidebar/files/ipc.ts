...
import type { ClawCodexReadDirEntry, ClawCodexReadDirResult } from '@/global'
...
export type ProjectTreeEntry = ClawCodexReadDirEntry
...
function ignoredBy(rules: GitignoreRule[], entry: ClawCodexReadDirEntry) {
...
async function filterIgnored(entries: ClawCodexReadDirEntry[], rootPath: string, dirPath: string) {
...
export async function readProjectDir(dirPath: string, rootPath = dirPath): Promise<ClawCodexReadDirResult> {
