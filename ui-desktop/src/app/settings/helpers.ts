...
import type { ClawCodexConfigRecord, ConfigFieldSchema, ToolsetInfo } from '@/types/clawcodex'
...
export function getNested(obj: ClawCodexConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: ClawCodexConfigRecord, path: string, value: unknown): ClawCodexConfigRecord {
...
function personalityOptions(config: ClawCodexConfigRecord): string[] {
...
function commandProviderNames(config: ClawCodexConfigRecord, section: 'tts' | 'stt'): string[] {
