...
import { saveClawCodexConfig } from '@/clawcodex'
...
function fontFamilyFromConfig(config: ClawCodexConfigRecord): string {
...
export function TerminalFontSetting() {
  ...
  const { data: loadedConfig } = useClawCodexConfigRecord()
  ...
  const [staleConfig, setStaleConfig] = useState<ClawCodexConfigRecord | null>(null)
  ...
  useEffect(() => {
    ...
    // holds — successful saves write it back via setClawCodexConfigCache, so
        ...
        <div className="mt-3 space-y-2">
          <div className="flex items-center gap-3">
            <Input
              ...
              className="flex-1"
              disabled={draft === null}
              list="clawcodex-terminal-font-families"
          ...
          <datalist id="clawcodex-terminal-font-families">
