...
vi.mock('@/clawcodex', () => ({
  saveClawCodexConfig: (config: Record<string, unknown>) => mocks.save(config)
}))
...
vi.mock('../hooks/use-config-record', () => ({
  setClawCodexConfigCache: (config: Record<string, unknown>) => mocks.cache(config),
  useClawCodexConfigRecord: () => ({ data: mocks.loadedConfig })
}))
