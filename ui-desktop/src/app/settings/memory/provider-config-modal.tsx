...
import { saveMemoryProviderConfig } from '@/clawcodex'
...
import type { MemoryProviderConfig, MemoryProviderField } from '@/types/clawcodex'
          ...
          {config.docs_url && (
            <a
              ...
              onClick={event => {
                ...
                void window.clawcodexDesktop?.openExternal?.(config.docs_url)
              }}
              rel="noreferrer"
              target="_blank"
            >
