...
import { CLAWCODEX_PATHS_MIME, type DroppedFile, extractDroppedFiles } from './use-composer-actions'
...
const dragKindOf = (event: ReactDragEvent): DragKind =>
  dragHasAttachments(event.dataTransfer, CLAWCODEX_PATHS_MIME) ? 'files' : null
