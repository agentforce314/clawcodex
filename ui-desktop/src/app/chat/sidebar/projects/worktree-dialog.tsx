...
import type { ClawCodexGitBranch } from '@/global'
...
const branchActionLabel = (branch: ClawCodexGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<ClawCodexGitBranch[]>([])
  ...
  const convert = async (branch: ClawCodexGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
