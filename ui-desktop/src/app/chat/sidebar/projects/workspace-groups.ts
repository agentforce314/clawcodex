import type { ProjectInfo, SessionInfo } from '@/clawcodex'
 ...
 * repo shows its branches/worktrees even when they have no ClawCodex sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: ClawCodexGitWorktree[]
): SidebarSessionGroup[] {
