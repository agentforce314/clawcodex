...
import { searchSessions, type SessionInfo, type SessionSearchResult } from '@/clawcodex'
...
export function ChatSidebar({
  ...
  useEffect(() => {
    ...
    window.addEventListener('clawcodex:new-session-shortcut', onShortcut)

    return () => {
      window.removeEventListener('clawcodex:new-session-shortcut', onShortcut)
      clearTimeout(timeout)
    }
  }, [])
  ...
  // A turn can `git worktree add/remove` in the terminal (e.g. you ask ClawCodex to
