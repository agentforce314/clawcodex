...
function harness(gateway: ClawCodexGateway) {
...
describe('useSlashCompletions', () => {
  it('serves the bare-slash catalog from cache instead of re-requesting it', async () => {
    ...
    const api = harness({ request } as unknown as ClawCodexGateway)
  ...
  // ones that shipped with ClawCodex and were never opened.
