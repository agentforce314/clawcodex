...
const FOCUS_EVENT = 'clawcodex:composer-focus'
const INSERT_EVENT = 'clawcodex:composer-insert'
const INSERT_REFS_EVENT = 'clawcodex:composer-insert-refs'
const SUBMIT_EVENT = 'clawcodex:composer-submit'
const VOICE_TOGGLE_EVENT = 'clawcodex:composer-voice-toggle'
const MODEL_MENU_EVENT = 'clawcodex:composer-model-menu'
