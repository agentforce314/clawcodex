...
const POPOUT_STORAGE_KEY = 'clawcodex.desktop.composerPopout.zones.v1'
...
const LEGACY_ENABLED_KEY = 'clawcodex.desktop.composerPopout.enabled'
const LEGACY_POSITION_KEY = 'clawcodex.desktop.composerPopout.position'
