...
export interface PetInfo {
  ...
  // the ClawCodex "run" activity state uses the in-place running row).
 ...
 * CLAWCODEX_CONFIG_DIR — so every pet RPC carries this. The gateway no-ops it for the
 ...
 */
const ROAM_KEY = 'clawcodex.desktop.pet-roam.v1'
