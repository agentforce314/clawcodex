...
const TILES_KEY = 'clawcodex.desktop.sessionTiles.v2'
const LEGACY_TILES_KEY = 'clawcodex.desktop.sessionTiles.v1'
...
// Dev hook for automation (mirrors __CLAWCODEX_LAYOUT_TREE__).
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__CLAWCODEX_SESSION_TILES__ = {
