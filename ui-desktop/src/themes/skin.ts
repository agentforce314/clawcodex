/**
 * ClawCodex skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$CLAWCODEX_CONFIG_DIR/skins/` (or a
 * built-in) resolved by `clawcodex_cli/skin_engine.py` and pushed to every surface
 ...
 * skin ClawCodex authors from a prompt lights up all three surfaces from one file.
 *
...
import type { ClawCodexSkin, SkinColors } from '@clawcodex/shared/skin'
 ...
 */
export function skinToDesktopTheme(skin: ClawCodexSkin): DesktopTheme | null {
