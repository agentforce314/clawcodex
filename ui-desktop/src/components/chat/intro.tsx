...
const FALLBACK_COPY: IntroCopy[] = [
  ...
  {
    headline: 'What should ClawCodex look at?',
...
function fallbackCopyForPersonality(personalityKey: string): IntroCopy[] {
  ...
  return [
    ...
    {
      headline: `What does ${label} ClawCodex need to see?`,
    ...
    {
      headline: `What should ${label} ClawCodex tackle?`,
...
const WORDMARK = 'CLAWCODEX AGENT'
