...
export const en: Translations = {
  ...
  boot: {
    ready: 'ClawCodex Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading ClawCodex settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingClawCodexDesktop: 'Starting ClawCodex Desktop…'
    },
    errors: {
      backgroundExited: 'ClawCodex background process exited.',
      backgroundExitedDuringStartup: 'ClawCodex background process exited during startup.',
    ...
    failure: {
      title: "ClawCodex couldn't start",
      description:
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your ClawCodex backend is older than this desktop build and may not work correctly. Update to align them.',
    installMethodUnsupportedTitle: 'Unsupported install method',
    updateClawCodex: 'Update ClawCodex',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting ClawCodex Desktop.',
    ...
    native: {
      ...
      inputBody: 'ClawCodex is waiting for your response.',
      turnDoneTitle: 'ClawCodex finished',
      turnDoneBody: '',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to ClawCodex defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while ClawCodex is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'ClawCodex asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while ClawCodex was in the background.'
        },
        turnError: {
          label: 'Turn failed',
        ...
        plugin: {
          ...
          description: 'A desktop plugin sent a notification while ClawCodex was in the background.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let ClawCodex follow your system setting.',
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and ClawCodex can react to yours.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what ClawCodex is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen ClawCodex, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'ClawCodex checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading ClawCodex configuration...',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening ClawCodex.',
    ...
    gateway: {
      ...
      intro:
        'Local by default. Use remote when this app should drive a ClawCodex backend elsewhere. Per-profile overrides below.',
      ...
      envOverrideDesc:
        'Unset CLAWCODEX_DESKTOP_REMOTE_URL and CLAWCODEX_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      modeTitle: 'Connection mode',
      localTitle: 'Local gateway',
      localDesc: 'Start a private ClawCodex backend on localhost. This is the default and works offline.',
      inheritTitle: 'Use default gateway',
      inheritDesc: "Remove this profile's override and use the default connection.",
      remoteTitle: 'Remote gateway',
      remoteDesc: 'Connect this desktop shell to a remote ClawCodex backend.',
      remoteAuthHint: 'Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      cloudTitle: 'ClawCodex Cloud',
      cloudDesc: 'Sign in once to ClawCodex Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'ClawCodex Cloud',
      cloudSignIn: 'Sign in to ClawCodex Cloud',
      cloudSignedIn: 'Signed in to ClawCodex Cloud',
      cloudNeedsSignIn: 'Sign in to ClawCodex Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your ClawCodex Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'ClawCodex Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of ClawCodex Cloud',
      cloudSignedOutMessage: 'Cleared the ClawCodex Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /clawcodex.',
      ...
      restartingMessage: 'ClawCodex Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · ClawCodex ${version}` : ''}`,
      ...
      sshDesc:
        'ClawCodex is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshClawCodexPathTitle: 'ClawCodex path (optional)',
      sshClawCodexPathDesc: 'Full path to the remote clawcodex binary. Blank = auto-detect.',
      sshClawCodexPathPlaceholder: 'auto-detect',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — ClawCodex found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — ClawCodex runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'ClawCodex is not installed on the remote host. Install it there (curl -fsSL https://github.com/agentforce314/clawcodex/install.sh | sh) or set the ClawCodex path.',
      sshErrPlatform:
        'Unsupported remote platform. ClawCodex Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update ClawCodex on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. ClawCodex runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point ClawCodex at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via clawcodex curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As ClawCodex builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart ClawCodex to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update ClawCodex to generate pets.',
      backgroundHint: 'You can close this — ClawCodex will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure ClawCodex desktop' },
    ...
    clawcodexActiveSessions: (version, count) => `ClawCodex ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@clawcodex:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent ClawCodex environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. ClawCodex will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    projects: {
      ...
      staleBackend:
        'Update the ClawCodex backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from ClawCodex. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting ClawCodex...',
    placeholderReconnecting: 'Reconnecting to ClawCodex…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give ClawCodex a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'ClawCodex will fetch the page and include it as context for this turn.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Ask ClawCodex to open PR',
      agentShipPrompt:
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating ClawCodex…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting ClawCodex…',
    ...
    unsupportedMessage: 'This version of ClawCodex can’t update itself from inside the app.',
    ...
    manualBody: 'You installed ClawCodex from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'ClawCodex will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the ClawCodex desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The ClawCodex updater takes over in its own window and reopens ClawCodex automatically when it’s done. Please don’t reopen ClawCodex yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. ClawCodex reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then ClawCodex reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'ClawCodex needs a one-time install',
    ...
    setupChoiceTitle: 'Set up ClawCodex Desktop',
    setupChoiceDesc:
      'Connect this app to a ClawCodex gateway you already run, or install ClawCodex locally on this computer.',
    connectExistingTitle: 'Connect to existing ClawCodex',
    ...
    installLocalTitle: 'Install ClawCodex locally',
    installLocalDesc: 'Download ClawCodex, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart ClawCodex Desktop and try again.',
    remoteSetupTitle: 'Connect to existing ClawCodex',
    remoteSetupDesc: 'Enter your gateway URL. ClawCodex Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the ClawCodex gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/clawcodex',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that ClawCodex gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
    ...
    settingUpTitle: 'Setting up ClawCodex',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another ClawCodex CLI or desktop instance is running. Stop any running ClawCodex instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The ClawCodex installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with ClawCodex",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'ClawCodex is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting ClawCodex…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run ClawCodex',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point ClawCodex at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — ClawCodex connects automatically',
    ...
    authorizeThere: 'Authorize ClawCodex there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize ClawCodex there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      desktopVersion: version => `ClawCodex Desktop v${version}`,
      backendVersion: version => `Backend v${version}`,
      clientLabel: version => `client v${version}`,
      connectionSsh: host => `SSH: ${host}`,
      connectionRemote: host => `Remote: ${host}`,
      connectionCloud: host => `Cloud: ${host}`,
      connectionCloudTooltip: host => `ClawCodex Cloud · ${host}`,
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. ClawCodex will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'ClawCodex is restarting...',
      askRestart: 'Ask ClawCodex to restart the server',
      lookingRestart: taskId => `ClawCodex is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'ClawCodex is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `ClawCodex finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'ClawCodex could not restart the server.',
      stillWorking:
        'ClawCodex is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'ClawCodex is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'ClawCodex gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.clawcodex/config.yaml). ClawCodex won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'ClawCodex needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'ClawCodex needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart ClawCodex Desktop to use Save Image.',
    restartToSaveImages: 'Restart ClawCodex Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `clawcodex gateway` running?'
    }
  },
