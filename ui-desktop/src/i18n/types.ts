...
export interface Translations {
  ...
  boot: {
    ...
    steps: {
      ...
      startingClawCodexDesktop: string
    }
    errors: {
  ...
  settings: {
    ...
    gateway: {
      ...
      sshKeyTitle: string
      sshKeyDesc: string
      sshClawCodexPathTitle: string
      sshClawCodexPathDesc: string
      sshClawCodexPathPlaceholder: string
  ...
  commandCenter: {
    ...
    clawcodexActiveSessions: (version: string, count: number) => string
