...
import { type BillingBlock, skillInvocationText } from '@clawcodex/shared'
...
import type { MessageReaction, SessionMessage, UsageStats } from '@/types/clawcodex'
...
export type GatewayEventPayload = {
  ...
  // with FailoverReason.billing (shape mirrors @clawcodex/shared BillingBlock).
