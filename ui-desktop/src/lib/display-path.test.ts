...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/clawcodex')).toBe('~/www/clawcodex')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/clawcodex')).toBe('clawcodex')
    expect(pathLeaf('~/www/clawcodex')).toBe('clawcodex')
