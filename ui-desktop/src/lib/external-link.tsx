...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|clawcodex):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.clawcodexDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.clawcodexDesktop?.openExternal?.(href)
  }
}
