 ...
 * `src/plugins/` with a `plugin.tsx` that default-exports a `ClawCodexPlugin` is
 ...
 *
 * The ONLY import surface is `@clawcodex/plugin-sdk` (lint-enforced) — the
