...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@clawcodex/plugin-sdk'
...
/** First-class ClawCodex projects, for scoping a board's default workspace. */
