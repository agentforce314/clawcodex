 ...
 * `<clawcodex home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'clawcodex.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'clawcodex.desktop.disabledPlugins.v1'
