...
/**
 * The ClawCodex mark: a bracketed claw. Drawn as a path rather than imported
 * so it inherits ink from whatever row it sits in — the sidebar rail and the
 * hero headline use the same glyph at two sizes.
 */
export const ClawMarkIcon = ({ size = 24, ...rest }: IconProps) => (
  <svg
    aria-hidden="true"
    fill="none"
    focusable="false"
  ...
  >
    <path
      d="M8.6 3.2 5.2 6.6a1.4 1.4 0 0 0 0 2l3.4 3.4"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
    />
    <path
      d="M15.4 20.8l3.4-3.4a1.4 1.4 0 0 0 0-2l-3.4-3.4"
      stroke="currentColor"
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
